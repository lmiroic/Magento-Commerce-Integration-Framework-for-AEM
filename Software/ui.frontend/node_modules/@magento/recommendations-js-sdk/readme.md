...
-   [Registering recommendations](#registering-recommendations)
-   [Registering custom recommendations](#registering-custom-recommendations)
-   [Fetching recommendations](#fetching-recommendations)
-   [Injecting recommendations on your web site](#injecting-recommendations-on-your-web-site)
-   [Defining a template](#defining-a-template)
-   [Rendering a recommendation on your web site](#rendering-a-recommendation-on-your-web-site)
-   [Using the SDK from start to finish](#using-the-sdk-from-start-to-finish)
